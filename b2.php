...
if(isset($_GET['bk']))
{
	$query=mysqli_query($connect,"SELECT `s2` FROM `slots` WHERE 1 ") or die(mysqli_error($connect));
...
{
	$s2 = $s2-1;
	$query=mysqli_query($connect,"UPDATE `slots` SET `s2`=$s2 ") or die(mysqli_error($db));
...
<div class="bg-img1">
<br>
<h3><center>Book Slot in EV-Station 2</center></h3>
