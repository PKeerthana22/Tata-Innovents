...
if((isset($_GET['user']))&&(isset($_GET['pswd'])))
{
    ...
    echo $id;
	echo $pswd;
  $query=mysqli_query($conn,"SELECT * FROM `user_details` WHERE  `email`='$id' && `password`='$pswd'") or die(mysqli_error($conn));
...
<center>
   ...
   <h1>E-Vehicle Monitoring and Slot Booking System</h1>
   <h1>Login</h1>
</center>
    <hr>
  <center><img src="user.png" alt="Avatar" class="avatar" height="10%" width="10%">
   </center>
