...
if(isset($_GET['bk']))
{
	$query=mysqli_query($connect,"SELECT `s4` FROM `slots` WHERE 1 ") or die(mysqli_error($connect));
...
{
	$s4 = $s4-1;
	$query=mysqli_query($connect,"UPDATE `slots` SET `s4`=$s4 ") or die(mysqli_error($db));
...
<div class="bg-img1">
<br>
<h3><center>Book Slot in EV-Station 4</center></h3>
