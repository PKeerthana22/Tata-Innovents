...
if(isset($_GET['bk']))
{
	$query=mysqli_query($connect,"SELECT `s1` FROM `slots` WHERE 1 ") or die(mysqli_error($connect));
...
{
	$s1 = $s1-1;
	$query=mysqli_query($connect,"UPDATE `slots` SET `s1`=$s1 ") or die(mysqli_error($db));
...
<div class="bg-img1">
<br>
<h3><center>Book Slot in EV-Station 1</center></h3>
